...
$sql="SELECT * FROM user WHERE approval= 'WAITING_APPROVE'";
...
<h1 style="text-align: left;"><span style="color:green">APPROVE STUDENT</span></h1>  


<div id="content">
    <form name="Myform" id="Myform" action="tenantapproveprocess.php" method="post" onsubmit="return(Validate());">
    ...
    <table style="width:100px; margin-left:2em;">
        ...
        <tbody>
            <tr>
                ...
                <td style="font-size: 20px"><input type="text" name="uname1" id="uname1" required size="20px;" /></td>
            </tr>
            <tr>
