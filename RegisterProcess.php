<?php
	...
	$gender = htmlentities(stripslashes(mysql_real_escape_string($_POST['gender'])));
        ...
        $insertqry = mysql_query("Insert into user (fname,lname,phone,email,id,gender,borrowing_date,approval) values('$fname','$lname','$phone','$email','$admission','$gender', NOW(),'waiting_approve')") or die(mysql_error());
