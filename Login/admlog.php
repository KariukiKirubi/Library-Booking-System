...
<div id="header">
<div id="logo">
    <h1 style="text-align: center;"><span style="color:magenta">Admin Login</span></h1>  
</div>
</div>

<div id="content">
    <form name="Myform" id="Myform" action="admlogProcess.php" method="post" onsubmit="return(Validate());">
